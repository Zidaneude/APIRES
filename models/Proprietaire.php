...
class Proprietaire{
    ...
    // Toutes les méthodes et propriétés nécessaires à la gestion des données de la tables propreitaire
    public $table = "propreitaires";
    public $connexion = null;

    // Les propritées de l'objet  propreitaire
    public $id;
    public $nom;
    public $prenom;
    public $email;
    ...
    {
        $sql = "UPDATE $this->table SET nom=:nom, prenom=:prenom, email=:email, exe=: sexe,telephone=:telephone,mdp=:mdp WHERE id=:id";
